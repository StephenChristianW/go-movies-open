    ...
    "definitions": {
        ...
        "adminSwaggerResponse.AdminListSuccessResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "string",
                    "example": "{page:1, page_size: 10, total_pages: 100,data: [id1_Detail, id2_Detail, id3_Detail]}"
                },
                "msg": {
                    "type": "string",
                    "example": "ok"
        ...
        "inviteCodeSwaggerResponse.GetInviteCodeSuccessResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "string",
                    "example": "{id: codeID, code: code, username: username, status: 1, expired: 1, expiredTime: 2025-01-01 00:00:00, deleted: 1}"
                },
                "msg": {
                    "type": "string",
                    "example": "ok"
        ...
        "inviteCodeSwaggerResponse.ListInviteCodesSuccessResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "string",
                    "example": "{page:1, pagesize: 10, totalPages: 100,data: [id1_Detail, id2_Detail, id3_Detail]}"
                },
                "msg": {
                    "type": "string",
                    "example": "ok"
